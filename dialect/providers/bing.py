...
from dialect.providers.base import ProviderError, SoupProvider, Translation, TranslationError
...
class Provider(SoupProvider):
    ...
    trans_init_requests = ["parse_html"]
    ...
    def format_translation(self, text, src, dest):
        data = {"fromLang": "auto-detect", "text": text, "to": dest, "token": self._token, "key": self._key}
