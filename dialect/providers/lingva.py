...
from dialect.providers.base import InvalidLangCode, ProviderError, SoupProvider, TextToSpeechError, Translation
...
class Provider(SoupProvider):
    ...
    trans_init_requests = ["languages"]
    tts_init_requests = ["languages"]
